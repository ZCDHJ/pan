        ...
        <div  class="time-machine m-l-lg panel box-shadow-wrap-normal">
            ...
            <div class="panel-footer">
                <div class="say_footer">
                    ...
                    <span class="text-muted m-xs comment-time-reply"><?php $comments->reply(_mt('<i class="iconfont icon-redo"></i>'));
                        ?></span>
                    <?php endif; ?>
...
if (!array_key_exists("time_first_letter",$expert) ? true: @$expert["time_first_letter"]):?>
<style>
