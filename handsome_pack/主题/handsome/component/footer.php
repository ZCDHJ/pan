...
<?php Content::outputCommentJS($this, $this->security); ?>
  ...
  <footer id="footer" class="app-footer" role="footer">
    <div class="wrapper bg-light">
      ...
      <?php if (@in_array('showSettingsButton',$this->options->featuresetup) || $this->options->dark_setting == "auto")
          : ?>
...
<?php if (@$expert["setting_only_day_mode"] === true || (!in_array('showSettingsButton',
            $this->options->featuresetup) && $this->options->dark_setting == "auto")): ?>
<style>
...
<script src="<?php echo $PUBLIC_CDN_ARRAY['vditor']?>/dist/method.min.js"></script>
<?php endif; ?>
<script>
    SearchConfig = {
        url: "<?php Helper::options()->pluginUrl('Preference/cache/search.json'); ?>"
    }
</script>
...
<?php if ($this->options->thumbArrangeStyle == "water_fall"): ?>
    <script src="https://cdn.jsdelivr.net/npm/macy@2.1.1/dist/macy.min.js"></script>
    <script>
