...
class Handsome
{
    ...
    const version = "7.3.0";//主版本号


    public static $versionTag = "2020081303";//版本号后缀，区别同一版本不同修改日期
    ...
    public static function getPluginCorrect()
    {
        ...
        foreach (Typecho_Plugin::export()["handles"]["admin/write-post.php:richEditor"] as $item){
